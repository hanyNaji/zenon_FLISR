...
###############------ CHANGE THIS ------###############
xml_file = r"D:\chnge order\FLISR\JUBAIL\ARAR\SCREENS\TRF.XML"
...
print("="*40)
print("  Extracting Machine Names and Variables from XML for SCREENS")
print("="*40)
...
for picture in root.findall(".//Picture"):
    ...
    for element in picture.findall(".//*[@TYPE='130']"):
        ...
        if "FDR" in id_val:  # RYAD # QASSIM # JUBAIL
