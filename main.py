...
###############------ CHANGE THIS ------###############
alc_xml_files = {
    r"D:\chnge order\FLISR\SERVICE ENGINE\ALKHARJ_DCC\SLD_ALAFLAG_OFFICE\RT\FILES\zenon\system\alc.XML",
    r"D:\chnge order\FLISR\SERVICE ENGINE\ALKHARJ_DCC\SLD_ALHOOTA_OFFICE\RT\FILES\zenon\system\alc.XML",
    r"D:\chnge order\FLISR\SERVICE ENGINE\ALKHARJ_DCC\SLD_SULAYIL_OFFICE\RT\FILES\zenon\system\alc.XML",
    r"D:\chnge order\FLISR\SERVICE ENGINE\ALKHARJ_DCC\SLD_WADI_ALDWASER_OFFICE\RT\FILES\zenon\system\alc.XML",
    }
scr_xml_file = r"D:\chnge order\FLISR\JUBAIL\SCREENS\HFR.XML"
output_folder = r"D:\chnge order\FLISR"  # D:\chnge order\FLISR\outputs\HASA_REGIN_ZENON\ABQIQ_PROJECT_SLD"

# ADMINISTRATION = "NED"
# OFFICE_NAME = "HFR"
# OFFICE_NO = ""
###############------ CHANGE THIS ------###############
for alc_xml_file in alc_xml_files:
    # --- Paths ---
    ...
    if __name__ == "__main__":
        ...
        #         try:
        #             subprocess.run(["explorer", "/select,", str(OUTPUT_FILE)], check=True)
        #         except Exception:
        #             pass
